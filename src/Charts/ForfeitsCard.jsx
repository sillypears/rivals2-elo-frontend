...
export default function ForfeitCard(className = '') {
    ...
    useEffect(() => {
        fetch(`http://${API_BASE_URL}:${API_BASE_PORT}/match_forfeits`)
            .then(res => res.json())
            .then(json => {
    ...
    return (
        <div className={`bg-gray-200 w-full text-black rounded-lg shadow-md text-center flex flex-col items-center justify-center ${className}`}>
